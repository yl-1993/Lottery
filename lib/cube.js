...
Cube.prototype.reset=function() {
    ...
    //console.log(Cube.prototype.getCornerOrientations());
    //console.log(Cube.prototype.getEdgeFace(3,3));
    //console.log(Cube.prototype.getEdgeFace(2,0));
    var i;
     ...
     {
         {
            ...
            if (tmask == 0) {
                ...
                //     tmp[i] = i* tmp[i-1];
                //     tmp[i+1] = (i-1)* getUnsolvedParts(i);
                // }

                // int unique  = getUnsolvedParts(k);
                // while(1)
                // {
                //     if(unique!=1)
                //         break;
                //     unique = getSideOrientations(getPartFace(unique));                   
                // }
            }
        }
    }
